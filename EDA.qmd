...
**How to use this template**: Each section contains code and short interpretation hints. Use it to produce summary tables and figures to inform feature engineering and cleaning.
